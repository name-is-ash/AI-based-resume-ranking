...
if OPENAI_API_KEY is None:
    st.error("API key is not defined in the environment. Please check your .env file.")
    st.stop()
...
def main():
    ...
    if submit and pdf:
        with st.spinner('Processing the resumes'):
            ...
            push_to_pinecone('pinecone_api_key',"gcp-starter","pdf",embeddings,final_docs_list)

            relavant_docs=similar_docs(job_description,document_count,'pinecone_api_key',"gcp-starter","pdf",embeddings,st.session_state['unique_id'])
